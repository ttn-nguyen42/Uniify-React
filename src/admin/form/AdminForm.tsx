                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    ...
                                    <br />
                                    Ví dụ: Trường Đại học Bách khoa TP.HCM;
                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    Viết hoa đầu câu, đầy đủ tên
                                    <br />
                                    Ví dụ: Ho Chi Minh University of Technology;
                    ...
                    <Row className="gap-3">
                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    Ngắn gọn, được viết tắt <b>Thành phố</b>{" "}
                                    thành <b>TP</b>, phải viết hoa đầu chữ
                                    <br />
                                    Ví dụ: Quận 10, TP.HCM; Hai Bà Trưng, Hà
                                    Nội;...
                                </Alert>
                                <Form.Control
                                    type="text"
                    ...
                    <Row>
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    Lấy URL ảnh từ Google, cách mỗi link sử dụng
                                    dấu ";", không cách dòng, không whitespace.
                                    Tối thiểu 3 ảnh
                                    <br />
                    ...
                    <Row className="gap-3">
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    Ảnh được đặt làm ảnh chính ở trang profile
                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    Ảnh được đặt làm ảnh bên phải đầu tiên ở
                                    trang profile riêng của trường trong mục{" "}
                                    <b>Khám phá</b>
                                    <br />
                                    Được dùng làm ảnh cho avatar nhỏ tại trang
                                    Explore
                                </Alert>
                                <Form.Control
                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    Ảnh được đặt làm ảnh bên phải thứ 2 ở trang
                                    profile riêng của trường trong mục{" "}
                                    <b>Khám phá</b>
                                    <br />
                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    ...
                                    <br />
                                    Viết hoa đầu dòng, các cơ sở cách nhau băng
                                    dấu ";"
                                    <br />
                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                >
                                    ...
                                    <br />
                                    Các email cách nhau 1 dấu ";", tối thiểu 1
                                    email
                                    <br />
                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                >
                                    Website của trường
                                    <br />
                                    Các website cách nhau 1 dấu ";", tối thiểu 1
                                    website
                                    <br />
                        ...
                        <Col md>
                            <Form.Group>
                                ...
                                <Alert variant="warning">
                                    Mã trường
                                    <br />
                                    Cách nhau băng dấu ";", tối thiếu 1 mã
                                    trường
                                    <br />
                                    Ví dụ: QSB;ABC
                                </Alert>
                ...
                <section>
                    <Form.Group>
                        ...
                        <Alert variant="warning">
                            ...
                            ";"
                            <br />
                            Không cần ghi điểm (tạm thời chỉ demo thôi nên điểm
                            sẽ được random hết)
                            <br />
                            Ví dụ: Khoa học máy tính;Công nghệ sinh học;Quản lý
                            công nghiệp;...
                        </Alert>
                        <Form.Control
